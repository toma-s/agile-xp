...
public class InitGameTest {
    ...
    public void testInitGame10bInit() {
        ...
        Assert.assertEquals("init playground on initial game config", 1, game.onTurn);
        Assert.assertEquals("init playground on initial game config", 1, ReversiTest.getPiece(game, 4, 5));
        Assert.assertEquals("init playground on initial game config", 1, ReversiTest.getPiece(game, 5, 4));
        Assert.assertEquals("init playground on initial game config", 0, ReversiTest.getPiece(game, 4, 4));
        Assert.assertEquals("init playground on initial game config", 0, ReversiTest.getPiece(game, 5, 5));
    }
