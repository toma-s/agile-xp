...
public class InitGameTest {
    ...
    public void testInitGame8bInit() {
        ...
        assertEquals("init playground on initial game config", Player.B, ReversiTest.getPiece(game, 3, 4));
        assertEquals("init playground on initial game config", Player.B, ReversiTest.getPiece(game, 4, 3));
        assertEquals("init playground on initial game config", Player.W, ReversiTest.getPiece(game, 3, 3));
        assertEquals("init playground on initial game config", Player.W, ReversiTest.getPiece(game, 4, 4));
    }
    ...
    public void testInitGame10bInit() {
        ...
        assertEquals("init playground on initial game config", Player.B, game.onTurn);
        assertEquals("init playground on initial game config", Player.B, ReversiTest.getPiece(game, 4, 5));
        assertEquals("init playground on initial game config", Player.B, ReversiTest.getPiece(game, 5, 4));
        assertEquals("init playground on initial game config", Player.W, ReversiTest.getPiece(game, 4, 4));
        assertEquals("init playground on initial game config", Player.W, ReversiTest.getPiece(game, 5, 5));
    }
